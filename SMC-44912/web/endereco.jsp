<%-- 
    Document   : endereco
    Created on : 03/12/2014, 16:00:55
    Author     : aluno
--%>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-4 well well-sm">
                            <legend><a href="http://www.jquery2dotnet.com"><i class="glyphicon glyphicon-map-marker"></i></a> Endereço</legend>
                            <form action="#" method="post" class="form" role="form">
                                <div class="row">
                                    <div class="col-xs-6 col-md-6">
                                        <input class="form-control" name="nome" placeholder="Número" type="text" required autofocus />
                                    </div>
                                </div>
                                <input class="form-control" name="logra" placeholder="Logradouro" type="text" />
